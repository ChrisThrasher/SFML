...
TEST_CASE("[Graphics] sf::Glsl")
{
    SECTION("Vec2")
    {
        SECTION("Type traits")
        {
            ...
            STATIC_CHECK(std::is_trivially_move_constructible_v<sf::Glsl::Vec2>);
            STATIC_CHECK(std::is_trivially_move_assignable_v<sf::Glsl::Vec2>);
        }
    ...
    SECTION("Ivec2")
    {
        SECTION("Type traits")
        {
            ...
            STATIC_CHECK(std::is_trivially_move_constructible_v<sf::Glsl::Ivec2>);
            STATIC_CHECK(std::is_trivially_move_assignable_v<sf::Glsl::Ivec2>);
        }
    ...
    SECTION("Bvec2")
    {
        SECTION("Type traits")
        {
            ...
            STATIC_CHECK(std::is_trivially_move_constructible_v<sf::Glsl::Bvec2>);
            STATIC_CHECK(std::is_trivially_move_assignable_v<sf::Glsl::Bvec2>);
        }
    ...
    SECTION("Vec3")
    {
        SECTION("Type traits")
        {
            ...
            STATIC_CHECK(std::is_trivially_move_constructible_v<sf::Glsl::Vec3>);
            STATIC_CHECK(std::is_trivially_move_assignable_v<sf::Glsl::Vec3>);
        }
    ...
    SECTION("Ivec3")
    {
        SECTION("Type traits")
        {
            ...
            STATIC_CHECK(std::is_trivially_move_constructible_v<sf::Glsl::Ivec3>);
            STATIC_CHECK(std::is_trivially_move_assignable_v<sf::Glsl::Ivec3>);
        }
    ...
    SECTION("Bvec3")
    {
        SECTION("Type traits")
        {
            ...
            STATIC_CHECK(std::is_trivially_move_constructible_v<sf::Glsl::Bvec3>);
            STATIC_CHECK(std::is_trivially_move_assignable_v<sf::Glsl::Bvec3>);
        }
    ...
    SECTION("Vec4")
    {
        SECTION("Type traits")
        {
            ...
            STATIC_CHECK(std::is_trivially_move_constructible_v<sf::Glsl::Vec4>);
            STATIC_CHECK(std::is_trivially_move_assignable_v<sf::Glsl::Vec4>);
        }
    ...
    SECTION("Ivec4")
    {
        SECTION("Type traits")
        {
            ...
            STATIC_CHECK(std::is_trivially_move_constructible_v<sf::Glsl::Ivec4>);
            STATIC_CHECK(std::is_trivially_move_assignable_v<sf::Glsl::Ivec4>);
        }
    ...
    SECTION("Bvec4")
    {
        SECTION("Type traits")
        {
            ...
            STATIC_CHECK(std::is_trivially_move_constructible_v<sf::Glsl::Bvec4>);
            STATIC_CHECK(std::is_trivially_move_assignable_v<sf::Glsl::Bvec4>);
        }
    ...
    SECTION("Mat3")
    {
        SECTION("Type traits")
        {
            ...
            STATIC_CHECK(std::is_trivially_move_constructible_v<sf::Glsl::Mat3>);
            STATIC_CHECK(std::is_trivially_move_assignable_v<sf::Glsl::Mat3>);
        }
    ...
    SECTION("Mat4")
    {
        SECTION("Type traits")
        {
            ...
            STATIC_CHECK(std::is_trivially_move_constructible_v<sf::Glsl::Mat4>);
